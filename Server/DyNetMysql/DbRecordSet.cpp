...
DbRecordSet::DbRecordSet( DbSession& dbtool , EDbMode eMode ):m_rDataBase( dbtool ) ,m_nCursor( 0 ),m_nKeyIndex( INVALID_KEY ) ,m_nAutoIncIndex( INVALID_KEY ) ,m_eMode( eMode )
{
...
ulong DbRecordSet::CountRecord() const
{
